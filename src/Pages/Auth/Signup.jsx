...
const Signup = () => {
  const [formData, setFormData] = useState({
    ...
    business_type: "",
    products: [],
    password: "signpost", // default password
    doorno: "",
    street: "",
    area: "",
    city: "",
  ...
  const handleSubmit = async (e) => {
    ...
    // Decide account type automatically
    const accountType = formData.business_name?.trim()
      ? "business"
      : "person";
    ...
    const payload = {
      ...formData,
      type: accountType,
      password: "signpost", // always default
      created_at: new Date(),
      updated_at: new Date(),
    };
  ...
  return (
    <form onSubmit={handleSubmit} className="container mt-4">
      ...
      {/* Person Prefix */}
      <div className="mb-3">
        <label className="form-label">Person Prefix</label><br />
        <div>
          <input
            type="radio"
            name="person_prefix"
          ...
          <input
            ...
            name="person_prefix"
            value="Mrs"
            checked={formData.person_prefix === "Mrs"}
            onChange={handleChange}
          /> Mrs{" "}
          <input
            type="radio"
      ...
      <div className="mb-3 form-check">
        <input
          ...
          onChange={handleChange}
        />
        <label className="form-check-label">Discount Available</label>
      </div>
